    ...
    <footer class="bg-primary shadow">
      <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          ...
          <span class="block text-sm text-gray-500 sm:text-center">© {{ date('Y') }} <a href="https://flowbite.com/" class="hover:underline">DevSolutions</a>. Todos los derechos reservados.</span>
      </div>
    </footer>
  </body>
</html>